  refdir = /home/saugat/Documents/phame/
  workdir = /home/saugat/Documents/phame/fna/ # directory where contigs/reads files are located and output is stored

  reference = 1  # 0:pick a random reference from refdir; 1:use given reference; 2: use ANI based reference
  reffile = TCH1516_full.fa  # reference filename when option 1 is chosen

  project = CC8  # main alignment file name
